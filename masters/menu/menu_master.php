                ...
                <p class="card-text">
                  <form action="menu_insup.php" method="POST" id="fo_insup">
                    ...
                    <div class="input-group mb-3 input-group-sm" id="div_modid">
                        ...
                        <select type="text" class="form-control"  name="modid" id="se_modid" onchange="get_mod_name()">
...
<script>
  function get_mod_name(){
     var selectElement = document.getElementById("se_modid");
     var selectedOptionText = selectElement.options[selectElement.selectedIndex].text;
     document.getElementById("te_mennm").value=selectedOptionText;
     document.getElementById("te_mennm").readOnly = true;
